...
def get_next_page(fnp_url = 'https://www.sindipetroba.org.br/2019/noticias/page/', next_page_number = 1, min_date = datetime(2025,6,1)):
...
def ba_extractor(min_date = datetime(2025,6,1)):
    next_page_number = 1
    validated_news_links = []
