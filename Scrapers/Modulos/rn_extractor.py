...
def get_next_page(fnp_url = 'https://www.sindipetrorn.org.br/noticias/', next_page_number = 1, min_date = datetime(2025,6,1)):
...
def rn_extractor(min_date = datetime(2025,6,1)):
    next_page_number = 1
    validated_news_links = []
